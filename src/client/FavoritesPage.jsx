...
const MAX_FAVORITE_NOTE_LENGTH = 200;
...
const FavoritesPage = ({ currentUser, onOpenPropertyDetails }) => {
    ...
    const handleSaveFavoriteNote = async (favoriteId, notes) => {
        ...
        if (normalizedNotes.length > MAX_FAVORITE_NOTE_LENGTH) {
            setErrorMessage(`Note cannot exceed ${MAX_FAVORITE_NOTE_LENGTH} characters.`);
            return;
        }
                        ...
                        <div className="flex flex-col gap-5 md:flex-row md:items-end md:justify-between">
                            ...
                            <label className="space-y-2">
                                ...
                                <select
                                    ...
                                    className="app-select-dark rounded-full px-4 py-2 text-sm font-medium text-white outline-none transition"
                                >
                    ...
                    <section className="space-y-6">
                        {favoriteProperties.map((property) => (
                            <FavoritePropertyCard
                                ...
                                maxNoteLength={MAX_FAVORITE_NOTE_LENGTH}
